...
\section{Bloqueo, autoblocante y vectorización de par}
\label{sec:diferencial:01}
\pendiente{Pendiente de redactar.}

\section{Efecto sobre el comportamiento del coche}
\label{sec:diferencial:02}
\pendiente{Pendiente de redactar.}

\section{Selección y ajuste}
\label{sec:diferencial:03}
\pendiente{Pendiente de redactar.}

\section{Mantenimiento}
\label{sec:diferencial:04}
\pendiente{Pendiente de redactar.}
