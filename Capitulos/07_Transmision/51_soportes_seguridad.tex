% !TeX root = ../../main.tex
% =====================================================================
%  Soportes, alineación y seguridad
%  Responsable: 
%  Última revisión: 
% =====================================================================
\chapter{Soportes, alineación y seguridad}
\label{ch:soportes_seguridad}
...
\section{Rigidez de los anclajes}
\label{sec:soportes_seguridad:01}
\pendiente{Pendiente de redactar.}

\section{Alineación y tolerancias}
\label{sec:soportes_seguridad:02}
\pendiente{Pendiente de redactar.}

\section{Resguardos y protecciones}
\label{sec:soportes_seguridad:03}
\pendiente{Pendiente de redactar.}

\section{Requisitos de reglamento}
\label{sec:soportes_seguridad:04}
\pendiente{Pendiente de redactar.}
