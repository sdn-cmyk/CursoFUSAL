...
%  Última revisión: 
% =====================================================================
\chapter{El evento de costes}
\label{ch:evento_costes}
...
\section{Estructura del informe de costes}
\label{sec:evento_costes:01}
\pendiente{Pendiente de redactar.}

\section{BOM y tablas de coste}
\label{sec:evento_costes:02}
\pendiente{Pendiente de redactar.}

\section{Costeo de procesos de fabricación}
\label{sec:evento_costes:03}
\pendiente{Pendiente de redactar.}

\section{Real Case Scenario}
\label{sec:evento_costes:04}
\pendiente{Pendiente de redactar.}

\section{Errores que penalizan}
\label{sec:evento_costes:05}
\pendiente{Pendiente de redactar.}
